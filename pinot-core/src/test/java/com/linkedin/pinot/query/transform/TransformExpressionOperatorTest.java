...
public class TransformExpressionOperatorTest {
  ...
  private double[] evaluateExpression(String expression) {
    ...
    TransformExpressionOperator transformOperator =
        new TransformExpressionOperator(_indexSegment, projectionOperator, expressionTree);
    transformOperator.open();
    IntermediateResultsBlock resultsBlock = (IntermediateResultsBlock) transformOperator.getNextBlock();
    double[] actual = resultsBlock.getTransformExpressionResult().getResultArray();
